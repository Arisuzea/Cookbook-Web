    ...
    <nav>
        <div class="wrapper">
            <div class="nav-container">
                <img src="../imgSources/Logo.png" alt="">
                <div class="links">
                    <a href="">Menu</a>
...
<section class="landingpage">
    <div class="content">
        ...
        <div class="image">
            <img src="../imgSources/Main.png" data-aos="zoom-in" data-aos-duration="2000">
        </div>
    </div>
</section>
<section class="aboutus">
    <div class="container">
        <img src="../imgSources/AboutUs.png" data-aos="zoom-in" data-aos-duration="1000">
...
<section class="details-foods">
    ...
    <div class="foods">
        <div class="card" data-aos="fade-up" data-aos-duration="1000">
            <img src="../imgSources/Adobo.png" alt="">
        ...
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <img src="../imgSources/Sinigang.png" alt="">
            <div class="discription">
                <h1>Sinigang</h1>
        ...
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            <img src="images/Karekare.png" alt="">
            <div class="discription">
                <h1>Kare-Kare</h1>
        ...
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
            <img src="../imgSources/HaloHalo.png" alt="">
            <div class="discription">
                <h1>Halo-Halo</h1>
